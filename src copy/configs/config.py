...
_C.MODEL.PROMPT_HEAD_PATH = "" #root folder for prompt head weight

_C.MODEL.TYPE = "prompted-dit"
_C.MODEL.MLP_NUM = 0
_C.MODEL.DEPTH = 28
_C.MODEL.CKPT = None
...
_C.MODEL.FEATURES_LAYER_LIST = [9]
_C.MODEL.ATTENTION_LAYER_LIST = []
_C.MODEL.FEATURES_TYPE_LIST = ['query']          #['feats', 'query', 'key', 'value', 'attn_output', 'attn_output_gated']
_C.MODEL.FUSION_ARC = "Use_CLS_Token:True:1536,Insert_CLS_Token,Attention:1536:8:4:2,Extract_CLS_Token"
_C.MODEL.T_LIST = [850]
_C.MODEL.FUSION_PRE_LAYER = True
_C.MODEL.FUSION_LINEAR_OUT_DIM = 256     #for resolution dimension modification
_C.MODEL.SAVE_FEATURES = False
_C.MODEL.UPSAMPLE = False
_C.MODEL.FUSION_TYPE = "attention"     # conv or linear or attention
_C.MODEL.FUSION_PRE_LAYER_TYPE = "attn_dim"  # attn_reso_dim, attn_dim, reso_dim
...
_C.DATA.CROPSIZE = 256 #224  # or 384
